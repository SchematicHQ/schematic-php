 ...
 */
class ListMetricCountsHourlyResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListMetricCountsHourlyResponse';
