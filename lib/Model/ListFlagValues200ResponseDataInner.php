<?php
/**
 * ListFlagValues200ResponseDataInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * ListFlagValues200ResponseDataInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ListFlagValues200ResponseDataInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'listFlagValues_200_response_data_inner';
    ...
    protected static $setters = [
        ...
        'flag_id' => 'setFlagId',
        'rule_id' => 'setRuleId',
        'targeting_level' => 'setTargetingLevel',
        'value' => 'setValue'
    ];
    ...
    protected static $getters = [
        ...
        'flag_id' => 'getFlagId',
        'rule_id' => 'getRuleId',
        'targeting_level' => 'getTargetingLevel',
        'value' => 'getValue'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('targeting_level', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets targeting_level
     *
     * @return int|null
     */
    public function getTargetingLevel()
    {
        return $this->container['targeting_level'];
    }

    /**
     * Sets targeting_level
     *
     * @param int|null $targeting_level targeting_level
     *
     * @return self
     */
    public function setTargetingLevel($targeting_level)
    {
        if (is_null($targeting_level)) {
            throw new \InvalidArgumentException('non-nullable targeting_level cannot be null');
        }
        $this->container['targeting_level'] = $targeting_level;
