 ...
 */
class UpdateEntityTraitDefinitionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateEntityTraitDefinitionResponse';
