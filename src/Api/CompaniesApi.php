...
class CompaniesApi
{
     ...
     * @return \Schematic\Model\CountCompaniesResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
    public function countCompanies($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countCompanies'][0])
    {
        list($response) = $this->countCompaniesWithHttpInfo($ids, $plan_id, $q, $without_feature_override_for, $without_plan, $limit, $offset, $contentType);
        return $response;
    }
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\CountCompaniesResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function countCompaniesWithHttpInfo($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countCompanies'][0])
    {
        $request = $this->countCompaniesRequest($ids, $plan_id, $q, $without_feature_override_for, $without_plan, $limit, $offset, $contentType);
     ...
     */
    public function countCompaniesAsync($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countCompanies'][0])
    {
        return $this->countCompaniesAsyncWithHttpInfo($ids, $plan_id, $q, $without_feature_override_for, $without_plan, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function countCompaniesAsyncWithHttpInfo($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countCompanies'][0])
    {
        $returnType = '\Schematic\Model\CountCompaniesResponse';
        $request = $this->countCompaniesRequest($ids, $plan_id, $q, $without_feature_override_for, $without_plan, $limit, $offset, $contentType);
     ...
     */
    public function countCompaniesRequest($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countCompanies'][0])
    {
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\CountEntityKeyDefinitionsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\CountEntityKeyDefinitionsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  string[] $ids ids (optional)
     * @param  string $q q (optional)
     * @param  string $trait_type trait_type (optional)
     * @param  int $limit Page limit (default 100) (optional)
     * @param  int $offset Page offset (default 0) (optional)
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\CountEntityTraitDefinitionsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
    public function countEntityTraitDefinitions($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countEntityTraitDefinitions'][0])
    {
        list($response) = $this->countEntityTraitDefinitionsWithHttpInfo($entity_type, $ids, $q, $trait_type, $limit, $offset, $contentType);
        return $response;
    }
     ...
     * @param  string[] $ids (optional)
     * @param  string $q (optional)
     * @param  string $trait_type (optional)
     * @param  int $limit Page limit (default 100) (optional)
     * @param  int $offset Page offset (default 0) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['countEntityTraitDefinitions'] to see the possible values for this operation
     *
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\CountEntityTraitDefinitionsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function countEntityTraitDefinitionsWithHttpInfo($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countEntityTraitDefinitions'][0])
    {
        $request = $this->countEntityTraitDefinitionsRequest($entity_type, $ids, $q, $trait_type, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function countEntityTraitDefinitionsAsync($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countEntityTraitDefinitions'][0])
    {
        return $this->countEntityTraitDefinitionsAsyncWithHttpInfo($entity_type, $ids, $q, $trait_type, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function countEntityTraitDefinitionsAsyncWithHttpInfo($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countEntityTraitDefinitions'][0])
    {
        $returnType = '\Schematic\Model\CountEntityTraitDefinitionsResponse';
        $request = $this->countEntityTraitDefinitionsRequest($entity_type, $ids, $q, $trait_type, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function countEntityTraitDefinitionsRequest($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['countEntityTraitDefinitions'][0])
    {
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\CountUsersResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\CountUsersResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\GetActiveCompanySubscriptionResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\GetActiveCompanySubscriptionResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation getActiveDeals
     *
     * Get active deals
     *
     * @param  string $company_id company_id (required)
     * @param  string $deal_stage deal_stage (required)
     * @param  int $limit Page limit (default 100) (optional)
     * @param  int $offset Page offset (default 0) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getActiveDeals'] to see the possible values for this operation
     *
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\GetActiveDealsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
    public function getActiveDeals($company_id, $deal_stage, $limit = null, $offset = null, string $contentType = self::contentTypes['getActiveDeals'][0])
    {
        list($response) = $this->getActiveDealsWithHttpInfo($company_id, $deal_stage, $limit, $offset, $contentType);
        return $response;
    }

    /**
     * Operation getActiveDealsWithHttpInfo
     *
     * Get active deals
     *
     * @param  string $company_id (required)
     * @param  string $deal_stage (required)
     * @param  int $limit Page limit (default 100) (optional)
     * @param  int $offset Page offset (default 0) (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getActiveDeals'] to see the possible values for this operation
     *
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\GetActiveDealsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getActiveDealsWithHttpInfo($company_id, $deal_stage, $limit = null, $offset = null, string $contentType = self::contentTypes['getActiveDeals'][0])
    {
        $request = $this->getActiveDealsRequest($company_id, $deal_stage, $limit, $offset, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Schematic\Model\GetActiveDealsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Schematic\Model\GetActiveDealsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Schematic\Model\GetActiveDealsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Schematic\Model\GetActiveDealsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Schematic\Model\GetActiveDealsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getActiveDealsAsync($company_id, $deal_stage, $limit = null, $offset = null, string $contentType = self::contentTypes['getActiveDeals'][0])
    {
        return $this->getActiveDealsAsyncWithHttpInfo($company_id, $deal_stage, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getActiveDealsAsyncWithHttpInfo
     *
     * Get active deals
     *
     * @param  string $company_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getActiveDealsAsyncWithHttpInfo($company_id, $deal_stage, $limit = null, $offset = null, string $contentType = self::contentTypes['getActiveDeals'][0])
    {
        $returnType = '\Schematic\Model\GetActiveDealsResponse';
        $request = $this->getActiveDealsRequest($company_id, $deal_stage, $limit, $offset, $contentType);
    ...
    /**
     * Create request for operation 'getActiveDeals'
     *
     * @param  string $company_id (required)
     * @param  string $deal_stage (required)
     * @param  int $limit Page limit (default 100) (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getActiveDealsRequest($company_id, $deal_stage, $limit = null, $offset = null, string $contentType = self::contentTypes['getActiveDeals'][0])
    {

        // verify the required parameter 'company_id' is set
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_id when calling getActiveDeals'
            );
        }

        // verify the required parameter 'deal_stage' is set
        if ($deal_stage === null || (is_array($deal_stage) && count($deal_stage) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $deal_stage when calling getActiveDeals'
            );
        }
        ...
        $resourcePath = '/company-crm-deals';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\GetEntityTraitValuesResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\GetEntityTraitValuesResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     */
    public function listCompanies($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listCompanies'][0])
    {
        list($response) = $this->listCompaniesWithHttpInfo($ids, $plan_id, $q, $without_feature_override_for, $without_plan, $limit, $offset, $contentType);
        return $response;
    }
     ...
     */
    public function listCompaniesWithHttpInfo($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listCompanies'][0])
    {
        $request = $this->listCompaniesRequest($ids, $plan_id, $q, $without_feature_override_for, $without_plan, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCompaniesAsync($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listCompanies'][0])
    {
        return $this->listCompaniesAsyncWithHttpInfo($ids, $plan_id, $q, $without_feature_override_for, $without_plan, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listCompaniesAsyncWithHttpInfo($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listCompanies'][0])
    {
        $returnType = '\Schematic\Model\ListCompaniesResponse';
        $request = $this->listCompaniesRequest($ids, $plan_id, $q, $without_feature_override_for, $without_plan, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listCompaniesRequest($ids = null, $plan_id = null, $q = null, $without_feature_override_for = null, $without_plan = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listCompanies'][0])
    {
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\ListEntityKeyDefinitionsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\ListEntityKeyDefinitionsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\ListEntityTraitDefinitionsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
    public function listEntityTraitDefinitions($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEntityTraitDefinitions'][0])
    {
        list($response) = $this->listEntityTraitDefinitionsWithHttpInfo($entity_type, $ids, $q, $trait_type, $limit, $offset, $contentType);
        return $response;
    }
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\ListEntityTraitDefinitionsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function listEntityTraitDefinitionsWithHttpInfo($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEntityTraitDefinitions'][0])
    {
        $request = $this->listEntityTraitDefinitionsRequest($entity_type, $ids, $q, $trait_type, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listEntityTraitDefinitionsAsync($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEntityTraitDefinitions'][0])
    {
        return $this->listEntityTraitDefinitionsAsyncWithHttpInfo($entity_type, $ids, $q, $trait_type, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listEntityTraitDefinitionsAsyncWithHttpInfo($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEntityTraitDefinitions'][0])
    {
        $returnType = '\Schematic\Model\ListEntityTraitDefinitionsResponse';
        $request = $this->listEntityTraitDefinitionsRequest($entity_type, $ids, $q, $trait_type, $limit, $offset, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listEntityTraitDefinitionsRequest($entity_type = null, $ids = null, $q = null, $trait_type = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEntityTraitDefinitions'][0])
    {
