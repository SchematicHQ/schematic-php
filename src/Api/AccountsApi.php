...
class AccountsApi
{
     ...
     * @return \Schematic\Model\CountApiKeysResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\CountApiKeysResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    /**
     * Operation countAuditLogsWithHttpInfo
     *
     * Count audit logs
     *
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Schematic\Model\CountAuditLogsResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Schematic\Model\CountAuditLogsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Schematic\Model\CountAuditLogsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Schematic\Model\CountAuditLogsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation countAuditLogsAsyncWithHttpInfo
     *
     * Count audit logs
     *
     * @param  ActorType $actor_type (optional)
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\CreateApiKeyResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\CreateApiKeyResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\CreateEnvironmentResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\CreateEnvironmentResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\DeleteApiKeyResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\DeleteApiKeyResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\DeleteEnvironmentResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\DeleteEnvironmentResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\GetAuditLogResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
    public function getAuditLog($audit_log_id, string $contentType = self::contentTypes['getAuditLog'][0])
    {
        list($response) = $this->getAuditLogWithHttpInfo($audit_log_id, $contentType);
        return $response;
    }
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\GetAuditLogResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAuditLogWithHttpInfo($audit_log_id, string $contentType = self::contentTypes['getAuditLog'][0])
    {
        $request = $this->getAuditLogRequest($audit_log_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Schematic\Model\GetAuditLogResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Schematic\Model\GetAuditLogResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Schematic\Model\GetAuditLogResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Schematic\Model\GetAuditLogResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Schematic\Model\GetAuditLogResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAuditLogAsync($audit_log_id, string $contentType = self::contentTypes['getAuditLog'][0])
    {
        return $this->getAuditLogAsyncWithHttpInfo($audit_log_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAuditLogAsyncWithHttpInfo($audit_log_id, string $contentType = self::contentTypes['getAuditLog'][0])
    {
        $returnType = '\Schematic\Model\GetAuditLogResponse';
        $request = $this->getAuditLogRequest($audit_log_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAuditLogRequest($audit_log_id, string $contentType = self::contentTypes['getAuditLog'][0])
    {

        // verify the required parameter 'audit_log_id' is set
        if ($audit_log_id === null || (is_array($audit_log_id) && count($audit_log_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $audit_log_id when calling getAuditLog'
            );
        }


        $resourcePath = '/audit-log/{audit_log_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\GetWhoAmIResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
    public function getWhoAmI(string $contentType = self::contentTypes['getWhoAmI'][0])
    {
        list($response) = $this->getWhoAmIWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\GetWhoAmIResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWhoAmIWithHttpInfo(string $contentType = self::contentTypes['getWhoAmI'][0])
    {
        $request = $this->getWhoAmIRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Schematic\Model\GetWhoAmIResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Schematic\Model\GetWhoAmIResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Schematic\Model\GetWhoAmIResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Schematic\Model\GetWhoAmIResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Schematic\Model\GetWhoAmIResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWhoAmIAsync(string $contentType = self::contentTypes['getWhoAmI'][0])
    {
        return $this->getWhoAmIAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWhoAmIAsyncWithHttpInfo(string $contentType = self::contentTypes['getWhoAmI'][0])
    {
        $returnType = '\Schematic\Model\GetWhoAmIResponse';
        $request = $this->getWhoAmIRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWhoAmIRequest(string $contentType = self::contentTypes['getWhoAmI'][0])
    {
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\ListApiKeysResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\ListApiKeysResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Schematic\Model\ListAuditLogsResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Schematic\Model\ListAuditLogsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Schematic\Model\ListAuditLogsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Schematic\Model\ListAuditLogsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\ListEnvironmentsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
    public function listEnvironments($ids = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEnvironments'][0])
    {
        list($response) = $this->listEnvironmentsWithHttpInfo($ids, $limit, $offset, $contentType);
        return $response;
    }
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\ListEnvironmentsResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function listEnvironmentsWithHttpInfo($ids = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEnvironments'][0])
    {
        $request = $this->listEnvironmentsRequest($ids, $limit, $offset, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Schematic\Model\ListEnvironmentsResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Schematic\Model\ListEnvironmentsResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Schematic\Model\ListEnvironmentsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Schematic\Model\ListEnvironmentsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Schematic\Model\ListEnvironmentsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listEnvironmentsAsync($ids = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEnvironments'][0])
    {
        return $this->listEnvironmentsAsyncWithHttpInfo($ids, $limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listEnvironmentsAsyncWithHttpInfo($ids = null, $limit = null, $offset = null, string $contentType = self::contentTypes['listEnvironments'][0])
    {
        $returnType = '\Schematic\Model\ListEnvironmentsResponse';
        $request = $this->listEnvironmentsRequest($ids, $limit, $offset, $contentType);
     ...
     * Quickstart
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['quickstart'] to see the possible values for this operation
     *
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Schematic\Model\QuickstartResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError
     */
    public function quickstart(string $contentType = self::contentTypes['quickstart'][0])
    {
        list($response) = $this->quickstartWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation quickstartWithHttpInfo
     *
     * Quickstart
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['quickstart'] to see the possible values for this operation
     ...
     * @throws \Schematic\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Schematic\Model\QuickstartResponse|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError|\Schematic\Model\ApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function quickstartWithHttpInfo(string $contentType = self::contentTypes['quickstart'][0])
    {
        $request = $this->quickstartRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Schematic\Model\QuickstartResponse' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\Schematic\Model\QuickstartResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Schematic\Model\QuickstartResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Schematic\Model\QuickstartResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Schematic\Model\QuickstartResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quickstartAsync(string $contentType = self::contentTypes['quickstart'][0])
    {
        return $this->quickstartAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation quickstartAsyncWithHttpInfo
     *
     * Quickstart
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['quickstart'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function quickstartAsyncWithHttpInfo(string $contentType = self::contentTypes['quickstart'][0])
    {
        $returnType = '\Schematic\Model\QuickstartResponse';
        $request = $this->quickstartRequest($contentType);
    ...
    /**
     * Create request for operation 'quickstart'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['quickstart'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function quickstartRequest(string $contentType = self::contentTypes['quickstart'][0])
    {


        $resourcePath = '/quickstart';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
