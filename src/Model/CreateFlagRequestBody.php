    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateFlagRequestBody., must be smaller than or equal to 1024.');
        }
    ...
    public function setKey($key)
    {
        ...
        if ((mb_strlen($key) > 512)) {
            throw new \InvalidArgumentException('invalid length for $key when calling CreateFlagRequestBody., must be smaller than or equal to 512.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateFlagRequestBody., must be smaller than or equal to 512.');
        }
