...
/**
 * UpdateEntityTraitDefinitionRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class UpdateEntityTraitDefinitionRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateEntityTraitDefinitionRequestBody';
    ...
    */
    ...
    public function setDisplayName($display_name)
    {
        ...
        if (!is_null($display_name) && (mb_strlen($display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling UpdateEntityTraitDefinitionRequestBody., must be smaller than or equal to 255.');
        }
