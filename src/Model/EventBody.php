 ...
 */
class EventBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventBody';
    ...
    */
     ...
     * Sets quantity
     *
     * @param int|null $quantity Optionally specify the quantity of the event
     *
     * @return self
     */
     ...
     * Sets keys
     *
     * @param array<string,string> $keys Key-value pairs to identify the user
     *
     * @return self
     */
