...
/**
 * GetActiveDealsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class GetActiveDealsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetActiveDealsParams';
    ...
    */
    ...
    public function setDealStage($deal_stage)
    {
        if (is_null($deal_stage)) {
            throw new \InvalidArgumentException('non-nullable deal_stage cannot be null');
        }
