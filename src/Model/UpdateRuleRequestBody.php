    ...
    */
    ...
    public function setConditionGroups($condition_groups)
    {
        ...
        if ((count($condition_groups) > 100)) {
            throw new \InvalidArgumentException('invalid value for $condition_groups when calling UpdateRuleRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setConditions($conditions)
    {
        ...
        if ((count($conditions) > 100)) {
            throw new \InvalidArgumentException('invalid value for $conditions when calling UpdateRuleRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateRuleRequestBody., must be smaller than or equal to 512.');
        }
