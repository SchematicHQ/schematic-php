...
/**
 * UsageBasedEntitlementRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class UsageBasedEntitlementRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UsageBasedEntitlementRequestBody';
    ...
    */
    ...
    public function setBillingThreshold($billing_threshold)
    {
        ...
        if (!is_null($billing_threshold) && ($billing_threshold > 9999999999999)) {
            throw new \InvalidArgumentException('invalid value for $billing_threshold when calling UsageBasedEntitlementRequestBody., must be smaller than or equal to 9999999999999.');
        }
        if (!is_null($billing_threshold) && ($billing_threshold < 50)) {
            throw new \InvalidArgumentException('invalid value for $billing_threshold when calling UsageBasedEntitlementRequestBody., must be bigger than or equal to 50.');
        }
