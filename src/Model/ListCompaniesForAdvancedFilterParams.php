...
/**
 * ListCompaniesForAdvancedFilterParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListCompaniesForAdvancedFilterParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListCompaniesForAdvancedFilterParams';
    ...
    */
    ...
    public function setSortOrderColumn($sort_order_column)
    {
        ...
        if ((mb_strlen($sort_order_column) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sort_order_column when calling ListCompaniesForAdvancedFilterParams., must be smaller than or equal to 255.');
        }
