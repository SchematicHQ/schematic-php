...
/**
 * CreateOrUpdateConditionGroupRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreateOrUpdateConditionGroupRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOrUpdateConditionGroupRequestBody';
    ...
    */
    ...
    public function setConditions($conditions)
    {
        ...
        if ((count($conditions) > 100)) {
            throw new \InvalidArgumentException('invalid value for $conditions when calling CreateOrUpdateConditionGroupRequestBody., number of items must be less than or equal to 100.');
        }
