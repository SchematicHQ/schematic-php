...
/**
 * CreatePlanBundleRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreatePlanBundleRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePlanBundleRequestBody';
    ...
    */
    ...
    public function setCreditGrants($credit_grants)
    {
        ...
        if ((count($credit_grants) > 100)) {
            throw new \InvalidArgumentException('invalid value for $credit_grants when calling CreatePlanBundleRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setEntitlements($entitlements)
    {
        ...
        if ((count($entitlements) > 100)) {
            throw new \InvalidArgumentException('invalid value for $entitlements when calling CreatePlanBundleRequestBody., number of items must be less than or equal to 100.');
        }
