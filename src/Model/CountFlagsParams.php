...
/**
 * CountFlagsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CountFlagsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountFlagsParams';
    ...
    */
     ...
     * Sets q
     *
     * @param string|null $q Search by flag name, key, or ID
     *
     * @return self
     */
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling CountFlagsParams., must be smaller than or equal to 512.');
        }
