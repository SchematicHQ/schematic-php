...
/**
 * CountCompaniesParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CountCompaniesParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountCompaniesParams';
    ...
    */
    ...
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling CountCompaniesParams., must be smaller than or equal to 512.');
        }
    ...
    public function setSortOrderColumn($sort_order_column)
    {
        ...
        if ((mb_strlen($sort_order_column) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sort_order_column when calling CountCompaniesParams., must be smaller than or equal to 255.');
        }
