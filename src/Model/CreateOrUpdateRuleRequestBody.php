...
class CreateOrUpdateRuleRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['condition_groups']) > 100)) {
            $invalidProperties[] = "invalid value for 'condition_groups', number of items must be less than or equal to 100.";
        }

        if ($this->container['conditions'] === null) {
            $invalidProperties[] = "'conditions' can't be null";
        }
        if ((count($this->container['conditions']) > 100)) {
            $invalidProperties[] = "invalid value for 'conditions', number of items must be less than or equal to 100.";
        }
    ...
    public function setConditionGroups($condition_groups)
    {
        ...
        if ((count($condition_groups) > 100)) {
            throw new \InvalidArgumentException('invalid value for $condition_groups when calling CreateOrUpdateRuleRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setConditions($conditions)
    {
        ...
        if ((count($conditions) > 100)) {
            throw new \InvalidArgumentException('invalid value for $conditions when calling CreateOrUpdateRuleRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateOrUpdateRuleRequestBody., must be smaller than or equal to 512.');
        }
