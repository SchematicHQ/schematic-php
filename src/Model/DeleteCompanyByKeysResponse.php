...
/**
 * DeleteCompanyByKeysResponse Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class DeleteCompanyByKeysResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeleteCompanyByKeysResponse';
    ...
    */
     ...
     * Sets data
     *
     * @param \Schematic\Model\CompanyResponseData $data data
     *
     * @return self
     */
