...
/**
 * IssueTemporaryAccessTokenRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class IssueTemporaryAccessTokenRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IssueTemporaryAccessTokenRequestBody';
    ...
    */
     ...
     * Sets lookup
     *
     * @param array<string,string> $lookup lookup
     *
     * @return self
     */
