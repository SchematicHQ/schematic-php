...
/**
 * ListComponentsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListComponentsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListComponentsParams';
    ...
    */
    ...
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling ListComponentsParams., must be smaller than or equal to 512.');
        }
