...
class CreateOrUpdateConditionRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets credit_cost
     *
     * @param float|null $credit_cost Cost of credit to use to measure this condition
     *
     * @return self
     */
     ...
     * Sets credit_id
     *
     * @param string|null $credit_id ID of credit to use to measure this condition
     *
     * @return self
     */
     ...
     * Sets metric_value
     *
     * @param int|null $metric_value Value to compare the track event metric against
     *
     * @return self
     */
    ...
    public function setResourceIds($resource_ids)
    {
        ...
        if ((count($resource_ids) > 1000)) {
            throw new \InvalidArgumentException('invalid value for $resource_ids when calling CreateOrUpdateConditionRequestBody., number of items must be less than or equal to 1000.');
        }
