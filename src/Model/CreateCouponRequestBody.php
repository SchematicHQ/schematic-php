...
/**
 * CreateCouponRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreateCouponRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCouponRequestBody';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['duration']) > 50)) {
            $invalidProperties[] = "invalid value for 'duration', the character length must be smaller than or equal to 50.";
        }
    ...
    public function setCurrency($currency)
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CreateCouponRequestBody., must be smaller than or equal to 3.');
        }
    ...
    public function setDuration($duration)
    {
        ...
        if ((mb_strlen($duration) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duration when calling CreateCouponRequestBody., must be smaller than or equal to 50.');
        }
    ...
    public function setExternalId($external_id)
    {
        ...
        if ((mb_strlen($external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling CreateCouponRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateCouponRequestBody., must be smaller than or equal to 255.');
        }
