...
class UpsertBillingProductRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_free_plan', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['is_free_plan'] === null) {
            $invalidProperties[] = "'is_free_plan' can't be null";
        }
     ...
     * @return bool
     */
    public function getIsFreePlan()
    {
        return $this->container['is_free_plan'];
    }

    /**
     * Sets is_free_plan
     *
     * @param bool $is_free_plan is_free_plan
     *
     * @return self
     */
    public function setIsFreePlan($is_free_plan)
    {
        if (is_null($is_free_plan)) {
            throw new \InvalidArgumentException('non-nullable is_free_plan cannot be null');
        }
        $this->container['is_free_plan'] = $is_free_plan;
