...
/**
 * ListPaymentMethodsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListPaymentMethodsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListPaymentMethodsParams';
    ...
    */
    ...
    public function setCustomerExternalId($customer_external_id)
    {
        ...
        if ((mb_strlen($customer_external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_external_id when calling ListPaymentMethodsParams., must be smaller than or equal to 255.');
        }
