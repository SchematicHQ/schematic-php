...
/**
 * CountAuditLogsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CountAuditLogsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountAuditLogsParams';
    ...
    */
     ...
     * Gets actor_type
     *
     * @return \Schematic\Model\ActorType|null
     */
     ...
     * Sets actor_type
     *
     * @param \Schematic\Model\ActorType|null $actor_type actor_type
     *
     * @return self
     */
    ...
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling CountAuditLogsParams., must be smaller than or equal to 512.');
        }
