...
/**
 * UpdatePlanEntitlementRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePlanEntitlementRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePlanEntitlementRequestBody';
    ...
    */
    ...
    public function setBillingThreshold($billing_threshold)
    {
        ...
        if (!is_null($billing_threshold) && ($billing_threshold > 9999999999999)) {
            throw new \InvalidArgumentException('invalid value for $billing_threshold when calling UpdatePlanEntitlementRequestBody., must be smaller than or equal to 9999999999999.');
        }
        if (!is_null($billing_threshold) && ($billing_threshold < 50)) {
            throw new \InvalidArgumentException('invalid value for $billing_threshold when calling UpdatePlanEntitlementRequestBody., must be bigger than or equal to 50.');
        }
