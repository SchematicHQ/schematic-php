...
/**
 * CreateBillingPlanCreditGrantRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreateBillingPlanCreditGrantRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateBillingPlanCreditGrantRequestBody';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['credit_amount'] > 9999999999)) {
    ...
    public function setAutoTopupAmount($auto_topup_amount)
    {
        ...
        if (!is_null($auto_topup_amount) && ($auto_topup_amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $auto_topup_amount when calling CreateBillingPlanCreditGrantRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAutoTopupExpiryUnitCount($auto_topup_expiry_unit_count)
    {
        ...
        if (!is_null($auto_topup_expiry_unit_count) && ($auto_topup_expiry_unit_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $auto_topup_expiry_unit_count when calling CreateBillingPlanCreditGrantRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setAutoTopupThresholdPercent($auto_topup_threshold_percent)
    {
        ...
        if (!is_null($auto_topup_threshold_percent) && ($auto_topup_threshold_percent > 100)) {
            throw new \InvalidArgumentException('invalid value for $auto_topup_threshold_percent when calling CreateBillingPlanCreditGrantRequestBody., must be smaller than or equal to 100.');
        }
        if (!is_null($auto_topup_threshold_percent) && ($auto_topup_threshold_percent < 1)) {
            throw new \InvalidArgumentException('invalid value for $auto_topup_threshold_percent when calling CreateBillingPlanCreditGrantRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setCreditAmount($credit_amount)
    {
        ...
        if (($credit_amount > 9999999999)) {
            throw new \InvalidArgumentException('invalid value for $credit_amount when calling CreateBillingPlanCreditGrantRequestBody., must be smaller than or equal to 9999999999.');
        }
        if (($credit_amount < 0)) {
            throw new \InvalidArgumentException('invalid value for $credit_amount when calling CreateBillingPlanCreditGrantRequestBody., must be bigger than or equal to 0.');
        }
    ...
    public function setExpiryUnitCount($expiry_unit_count)
    {
        ...
        if (!is_null($expiry_unit_count) && ($expiry_unit_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $expiry_unit_count when calling CreateBillingPlanCreditGrantRequestBody., must be bigger than or equal to 1.');
        }
