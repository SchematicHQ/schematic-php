...
/**
 * EventBodyTrack Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class EventBodyTrack implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EventBodyTrack';
    ...
    */
     ...
     * Sets company
     *
     * @param array<string,string>|null $company Key-value pairs to identify company associated with track event
     *
     * @return self
     */
