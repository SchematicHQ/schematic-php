...
/**
 * CheckFlagRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CheckFlagRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckFlagRequestBody';
    ...
    */
     ...
     * Sets company
     *
     * @param array<string,string>|null $company company
     *
     * @return self
     */
     ...
     * Sets user
     *
     * @param array<string,string>|null $user user
     *
     * @return self
     */
