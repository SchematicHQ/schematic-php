...
/**
 * UpsertUserSubRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class UpsertUserSubRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpsertUserSubRequestBody';
    ...
    */
    ...
    public function setCompanyIds($company_ids)
    {
        ...
        if (!is_null($company_ids) && (count($company_ids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $company_ids when calling UpsertUserSubRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpsertUserSubRequestBody., must be smaller than or equal to 256.');
        }
