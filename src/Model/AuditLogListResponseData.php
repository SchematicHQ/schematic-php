...
/**
 * AuditLogListResponseData Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class AuditLogListResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuditLogListResponseData';
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling AuditLogListResponseData., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling AuditLogListResponseData., must be bigger than or equal to 36.');
        }
    ...
    public function setMethod($method)
    {
        ...
        if ((mb_strlen($method) > 10)) {
            throw new \InvalidArgumentException('invalid length for $method when calling AuditLogListResponseData., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($method) < 1)) {
            throw new \InvalidArgumentException('invalid length for $method when calling AuditLogListResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setResourceIdString($resource_id_string)
    {
        ...
        if (!is_null($resource_id_string) && (mb_strlen($resource_id_string) > 256)) {
            throw new \InvalidArgumentException('invalid length for $resource_id_string when calling AuditLogListResponseData., must be smaller than or equal to 256.');
        }
    ...
    public function setResourceName($resource_name)
    {
        ...
        if (!is_null($resource_name) && (mb_strlen($resource_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $resource_name when calling AuditLogListResponseData., must be smaller than or equal to 256.');
        }
    ...
    public function setResourceType($resource_type)
    {
        ...
        if (!is_null($resource_type) && (mb_strlen($resource_type) > 64)) {
            throw new \InvalidArgumentException('invalid length for $resource_type when calling AuditLogListResponseData., must be smaller than or equal to 64.');
        }
    ...
    public function setRespCode($resp_code)
    {
        ...
        if (!is_null($resp_code) && ($resp_code > 599)) {
            throw new \InvalidArgumentException('invalid value for $resp_code when calling AuditLogListResponseData., must be smaller than or equal to 599.');
        }
        if (!is_null($resp_code) && ($resp_code < 100)) {
            throw new \InvalidArgumentException('invalid value for $resp_code when calling AuditLogListResponseData., must be bigger than or equal to 100.');
        }
    ...
    public function setSecondaryResource($secondary_resource)
    {
        ...
        if (!is_null($secondary_resource) && (mb_strlen($secondary_resource) > 256)) {
            throw new \InvalidArgumentException('invalid length for $secondary_resource when calling AuditLogListResponseData., must be smaller than or equal to 256.');
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $url when calling AuditLogListResponseData., must be smaller than or equal to 2048.');
        }
        if ((mb_strlen($url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $url when calling AuditLogListResponseData., must be bigger than or equal to 1.');
        }
    ...
    public function setUserName($user_name)
    {
        ...
        if (!is_null($user_name) && (mb_strlen($user_name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling AuditLogListResponseData., must be smaller than or equal to 256.');
        }
