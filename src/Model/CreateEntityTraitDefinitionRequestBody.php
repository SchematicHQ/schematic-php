...
/**
 * CreateEntityTraitDefinitionRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreateEntityTraitDefinitionRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateEntityTraitDefinitionRequestBody';
    ...
    */
    ...
    public function setDisplayName($display_name)
    {
        ...
        if (!is_null($display_name) && (mb_strlen($display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling CreateEntityTraitDefinitionRequestBody., must be smaller than or equal to 255.');
        }
