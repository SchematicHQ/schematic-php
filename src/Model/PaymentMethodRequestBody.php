    ...
    */
    ...
    public function setAccountLast4($account_last4)
    {
        ...
        if (!is_null($account_last4) && (mb_strlen($account_last4) > 4)) {
            throw new \InvalidArgumentException('invalid length for $account_last4 when calling PaymentMethodRequestBody., must be smaller than or equal to 4.');
        }
    ...
    public function setAccountName($account_name)
    {
        ...
        if (!is_null($account_name) && (mb_strlen($account_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $account_name when calling PaymentMethodRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setBankName($bank_name)
    {
        ...
        if (!is_null($bank_name) && (mb_strlen($bank_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_name when calling PaymentMethodRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setBillingEmail($billing_email)
    {
        ...
        if (!is_null($billing_email) && (mb_strlen($billing_email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $billing_email when calling PaymentMethodRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setBillingName($billing_name)
    {
        ...
        if (!is_null($billing_name) && (mb_strlen($billing_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $billing_name when calling PaymentMethodRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setCardBrand($card_brand)
    {
        ...
        if (!is_null($card_brand) && (mb_strlen($card_brand) > 32)) {
            throw new \InvalidArgumentException('invalid length for $card_brand when calling PaymentMethodRequestBody., must be smaller than or equal to 32.');
        }
    ...
    public function setCardLast4($card_last4)
    {
        ...
        if (!is_null($card_last4) && (mb_strlen($card_last4) > 4)) {
            throw new \InvalidArgumentException('invalid length for $card_last4 when calling PaymentMethodRequestBody., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerExternalId($customer_external_id)
    {
        ...
        if ((mb_strlen($customer_external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_external_id when calling PaymentMethodRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setPaymentMethodType($payment_method_type)
    {
        ...
        if ((mb_strlen($payment_method_type) > 32)) {
            throw new \InvalidArgumentException('invalid length for $payment_method_type when calling PaymentMethodRequestBody., must be smaller than or equal to 32.');
        }
