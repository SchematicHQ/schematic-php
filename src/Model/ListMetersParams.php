...
/**
 * ListMetersParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListMetersParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListMetersParams';
    ...
    */
    ...
    public function setDisplayName($display_name)
    {
        ...
        if ((mb_strlen($display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $display_name when calling ListMetersParams., must be smaller than or equal to 255.');
        }
