...
/**
 * ListCustomersWithSubscriptionsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListCustomersWithSubscriptionsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListCustomersWithSubscriptionsParams';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ListCustomersWithSubscriptionsParams., must be smaller than or equal to 255.');
        }
    ...
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling ListCustomersWithSubscriptionsParams., must be smaller than or equal to 512.');
        }
