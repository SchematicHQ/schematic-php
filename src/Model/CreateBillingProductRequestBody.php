...
/**
 * CreateBillingProductRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreateBillingProductRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateBillingProductRequestBody';
    ...
    */
    ...
    public function setExternalId($external_id)
    {
        ...
        if ((mb_strlen($external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling CreateBillingProductRequestBody., must be smaller than or equal to 255.');
        }
