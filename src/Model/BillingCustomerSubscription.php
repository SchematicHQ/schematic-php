...
/**
 * BillingCustomerSubscription Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class BillingCustomerSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BillingCustomerSubscription';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('metered_usage', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['metered_usage'] === null) {
            $invalidProperties[] = "'metered_usage' can't be null";
        }
        if ($this->container['per_unit_price'] === null) {
            $invalidProperties[] = "'per_unit_price' can't be null";
        }
     ...
     * @return bool
     */
    public function getMeteredUsage()
    {
        return $this->container['metered_usage'];
    }

    /**
     * Sets metered_usage
     *
     * @param bool $metered_usage metered_usage
     *
     * @return self
     */
    public function setMeteredUsage($metered_usage)
    {
        if (is_null($metered_usage)) {
            throw new \InvalidArgumentException('non-nullable metered_usage cannot be null');
        }
        $this->container['metered_usage'] = $metered_usage;
     ...
     * Sets per_unit_price
     *
     * @param int $per_unit_price per_unit_price
     *
     * @return self
     */
