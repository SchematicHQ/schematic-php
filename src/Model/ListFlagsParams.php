...
/**
 * ListFlagsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListFlagsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListFlagsParams';
    ...
    */
    ...
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling ListFlagsParams., must be smaller than or equal to 512.');
        }
