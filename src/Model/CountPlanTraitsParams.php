...
/**
 * CountPlanTraitsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CountPlanTraitsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountPlanTraitsParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('trait_ids', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (is_null($trait_ids)) {
            throw new \InvalidArgumentException('non-nullable trait_ids cannot be null');
        }
