...
class ApiKeyCreateResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['scopes']) > 50)) {
            $invalidProperties[] = "invalid value for 'scopes', number of items must be less than or equal to 50.";
        }
     ...
     * Gets scopes
     *
     * @return \Schematic\Model\ApiKeyScope[]
     */
     ...
     * Sets scopes
     *
     * @param \Schematic\Model\ApiKeyScope[] $scopes scopes
     *
     * @return self
     */
    public function setScopes($scopes)
    {
        ...
        if ((count($scopes) > 50)) {
            throw new \InvalidArgumentException('invalid value for $scopes when calling ApiKeyCreateResponseData., number of items must be less than or equal to 50.');
        }
