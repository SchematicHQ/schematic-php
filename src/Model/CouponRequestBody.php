    ...
    */
    ...
    public function setCurrency($currency)
    {
        ...
        if (!is_null($currency) && (mb_strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling CouponRequestBody., must be smaller than or equal to 3.');
        }
    ...
    public function setDuration($duration)
    {
        ...
        if ((mb_strlen($duration) > 50)) {
            throw new \InvalidArgumentException('invalid length for $duration when calling CouponRequestBody., must be smaller than or equal to 50.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CouponRequestBody., must be smaller than or equal to 255.');
        }
