...
/**
 * ListInvoicesParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListInvoicesParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListInvoicesParams';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['customer_external_id']) && (mb_strlen($this->container['customer_external_id']) > 255)) {
     ...
     *
     * @param string|null $customer_external_id customer_external_id
     *
     * @return self
     */
    public function setCustomerExternalId($customer_external_id)
    {
        ...
        if ((mb_strlen($customer_external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $customer_external_id when calling ListInvoicesParams., must be smaller than or equal to 255.');
        }
    ...
    public function setSubscriptionExternalId($subscription_external_id)
    {
        ...
        if ((mb_strlen($subscription_external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subscription_external_id when calling ListInvoicesParams., must be smaller than or equal to 255.');
        }
