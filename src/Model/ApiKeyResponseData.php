...
/**
 * ApiKeyResponseData Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class ApiKeyResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ApiKeyResponseData';
    ...
    */
    ...
    public function setScopes($scopes)
    {
        ...
        if ((count($scopes) > 50)) {
            throw new \InvalidArgumentException('invalid value for $scopes when calling ApiKeyResponseData., number of items must be less than or equal to 50.');
        }
