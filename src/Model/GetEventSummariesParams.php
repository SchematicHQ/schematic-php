...
/**
 * GetEventSummariesParams Class Doc Comment
 *
 * @category Class
 ...
 */
class GetEventSummariesParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetEventSummariesParams';
    ...
    */
    ...
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling GetEventSummariesParams., must be smaller than or equal to 512.');
        }
