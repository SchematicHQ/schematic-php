...
/**
 * CreateEnvironmentRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreateEnvironmentRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateEnvironmentRequestBody';
    ...
    */
     ...
     *
     * @return \Schematic\Model\EnvironmentType
     */
     ...
     *
     * @param \Schematic\Model\EnvironmentType $environment_type environment_type
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateEnvironmentRequestBody., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateEnvironmentRequestBody., must be bigger than or equal to 1.');
        }
