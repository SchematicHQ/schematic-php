    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateFeatureRequestBody., must be smaller than or equal to 1024.');
        }
     ...
     * Sets feature_type
     *
     * @param \Schematic\Model\FeatureType|null $feature_type feature_type
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 512)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateFeatureRequestBody., must be smaller than or equal to 512.');
        }
