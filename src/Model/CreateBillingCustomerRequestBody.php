    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateBillingCustomerRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setExternalId($external_id)
    {
        ...
        if ((mb_strlen($external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling CreateBillingCustomerRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateBillingCustomerRequestBody., must be smaller than or equal to 255.');
        }
