    ...
    */
    ...
    public function setAddOnIds($add_on_ids)
    {
        ...
        if ((count($add_on_ids) > 100)) {
            throw new \InvalidArgumentException('invalid value for $add_on_ids when calling ChangeSubscriptionInternalRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setCouponExternalId($coupon_external_id)
    {
        ...
        if (!is_null($coupon_external_id) && (mb_strlen($coupon_external_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $coupon_external_id when calling ChangeSubscriptionInternalRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setCreditBundles($credit_bundles)
    {
        ...
        if ((count($credit_bundles) > 100)) {
            throw new \InvalidArgumentException('invalid value for $credit_bundles when calling ChangeSubscriptionInternalRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setPayInAdvance($pay_in_advance)
    {
        ...
        if ((count($pay_in_advance) > 100)) {
            throw new \InvalidArgumentException('invalid value for $pay_in_advance when calling ChangeSubscriptionInternalRequestBody., number of items must be less than or equal to 100.');
        }
    ...
    public function setPaymentMethodId($payment_method_id)
    {
        ...
        if (!is_null($payment_method_id) && (mb_strlen($payment_method_id) > 255)) {
            throw new \InvalidArgumentException('invalid length for $payment_method_id when calling ChangeSubscriptionInternalRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setPromoCode($promo_code)
    {
        ...
        if (!is_null($promo_code) && (mb_strlen($promo_code) > 255)) {
            throw new \InvalidArgumentException('invalid length for $promo_code when calling ChangeSubscriptionInternalRequestBody., must be smaller than or equal to 255.');
        }
