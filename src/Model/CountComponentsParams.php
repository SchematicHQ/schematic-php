...
/**
 * CountComponentsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CountComponentsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountComponentsParams';
    ...
    */
    ...
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling CountComponentsParams., must be smaller than or equal to 512.');
        }
