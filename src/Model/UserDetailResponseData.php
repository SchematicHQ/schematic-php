 ...
 */
class UserDetailResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserDetailResponseData';
    ...
    {
        $this->setIfExists('company_memberships', $data ?? [], null);
