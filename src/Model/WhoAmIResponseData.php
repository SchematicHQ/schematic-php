...
/**
 * WhoAmIResponseData Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class WhoAmIResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WhoAmIResponseData';
    ...
    */
     ...
     * Gets environments
     *
     * @return \Schematic\Model\EnvironmentResponseData[]
     */
     ...
     * Sets environments
     *
     * @param \Schematic\Model\EnvironmentResponseData[] $environments environments
     *
     * @return self
     */
     ...
     * Sets stripe_user_id
     *
     * @param string|null $stripe_user_id stripe_user_id
     *
     * @return self
     */
    public function setStripeUserId($stripe_user_id)
    {
        if (is_null($stripe_user_id)) {
            throw new \InvalidArgumentException('non-nullable stripe_user_id cannot be null');
        }
