...
class PlanEntitlementResponseData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    /**
     * Gets metered_monthly_price
     *
     * @return \Schematic\Model\BillingPriceView|null
     */
    public function getMeteredMonthlyPrice()
    {
        return $this->container['metered_monthly_price'];
    }

    /**
     * Sets metered_monthly_price
     *
     * @param \Schematic\Model\BillingPriceView|null $metered_monthly_price metered_monthly_price
     *
     * @return self
     */
    public function setMeteredMonthlyPrice($metered_monthly_price)
    {
        if (is_null($metered_monthly_price)) {
            throw new \InvalidArgumentException('non-nullable metered_monthly_price cannot be null');
        }
        $this->container['metered_monthly_price'] = $metered_monthly_price;
     ...
     * @return \Schematic\Model\BillingPriceView|null
     */
    public function getMeteredYearlyPrice()
    {
        return $this->container['metered_yearly_price'];
    }

    /**
     * Sets metered_yearly_price
     *
     * @param \Schematic\Model\BillingPriceView|null $metered_yearly_price metered_yearly_price
     *
     * @return self
     */
    public function setMeteredYearlyPrice($metered_yearly_price)
    {
        if (is_null($metered_yearly_price)) {
            throw new \InvalidArgumentException('non-nullable metered_yearly_price cannot be null');
        }
        $this->container['metered_yearly_price'] = $metered_yearly_price;
    ...
    /**
     * Gets usage_based_product
     *
     * @return \Schematic\Model\BillingProductResponseData|null
     */
    public function getUsageBasedProduct()
    {
        return $this->container['usage_based_product'];
    }

    /**
     * Sets usage_based_product
     *
     * @param \Schematic\Model\BillingProductResponseData|null $usage_based_product usage_based_product
     *
     * @return self
     */
    public function setUsageBasedProduct($usage_based_product)
    {
        if (is_null($usage_based_product)) {
            throw new \InvalidArgumentException('non-nullable usage_based_product cannot be null');
        }
        $this->container['usage_based_product'] = $usage_based_product;
