...
/**
 * CreateCrmLineItemRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreateCrmLineItemRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCrmLineItemRequestBody';
    ...
    protected static $setters = [
        ...
        'line_item_external_id' => 'setLineItemExternalId',
        'product_external_id' => 'setProductExternalId',
        'quantity' => 'setQuantity',
        'term_month' => 'setTermMonth',
    ...
    protected static $getters = [
        ...
        'line_item_external_id' => 'getLineItemExternalId',
        'product_external_id' => 'getProductExternalId',
        'quantity' => 'getQuantity',
        'term_month' => 'getTermMonth',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('line_item_external_id', $data ?? [], null);
        $this->setIfExists('product_external_id', $data ?? [], null);
        $this->setIfExists('quantity', $data ?? [], null);
        $this->setIfExists('term_month', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['line_item_external_id'] === null) {
            $invalidProperties[] = "'line_item_external_id' can't be null";
        }
    ...
    /**
     * Gets line_item_external_id
     *
     * @return string
     */
    public function getLineItemExternalId()
    {
        return $this->container['line_item_external_id'];
    }

    /**
     * Sets line_item_external_id
     *
     * @param string $line_item_external_id line_item_external_id
     *
     * @return self
     */
    public function setLineItemExternalId($line_item_external_id)
    {
        if (is_null($line_item_external_id)) {
            throw new \InvalidArgumentException('non-nullable line_item_external_id cannot be null');
        }
        $this->container['line_item_external_id'] = $line_item_external_id;
    ...
    {
        return $this->container['term_month'];
    }

    /**
     * Sets term_month
     *
     * @param int|null $term_month term_month
     *
     * @return self
     */
    public function setTermMonth($term_month)
    {
        if (is_null($term_month)) {
            array_push($this->openAPINullablesSetToNull, 'term_month');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('term_month', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['term_month'] = $term_month;
     ...
     * Sets total_discount
     *
     * @param string|null $total_discount total_discount
     *
     * @return self
     */
