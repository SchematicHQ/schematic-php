...
/**
 * ListAuditLogsParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListAuditLogsParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListAuditLogsParams';
    ...
    */
    ...
    public function setQ($q)
    {
        ...
        if ((mb_strlen($q) > 512)) {
            throw new \InvalidArgumentException('invalid length for $q when calling ListAuditLogsParams., must be smaller than or equal to 512.');
        }
