...
/**
 * CreateCreditBundleRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreateCreditBundleRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateCreditBundleRequestBody';
    ...
    */
     ...
     * Gets bundle_type
     *
     * @return \Schematic\Model\BillingCreditBundleType|null
     */
     ...
     * Sets bundle_type
     *
     * @param \Schematic\Model\BillingCreditBundleType|null $bundle_type bundle_type
     *
     * @return self
     */
    ...
    public function setExpiryUnitCount($expiry_unit_count)
    {
        ...
        if (!is_null($expiry_unit_count) && ($expiry_unit_count < 1)) {
            throw new \InvalidArgumentException('invalid value for $expiry_unit_count when calling CreateCreditBundleRequestBody., must be bigger than or equal to 1.');
        }
    ...
    public function setPricePerUnit($price_per_unit)
    {
        ...
        if (($price_per_unit < 0)) {
            throw new \InvalidArgumentException('invalid value for $price_per_unit when calling CreateCreditBundleRequestBody., must be bigger than or equal to 0.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling CreateCreditBundleRequestBody., must be bigger than or equal to 1.');
        }
