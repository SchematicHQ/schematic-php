...
/**
 * ListBillingProductPricesParams Class Doc Comment
 *
 * @category Class
 ...
 */
class ListBillingProductPricesParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListBillingProductPricesParams';
    ...
    */
    ...
    public function setInterval($interval)
    {
        ...
        if ((mb_strlen($interval) > 255)) {
            throw new \InvalidArgumentException('invalid length for $interval when calling ListBillingProductPricesParams., must be smaller than or equal to 255.');
        }
