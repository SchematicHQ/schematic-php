...
/**
 * CountCompaniesForAdvancedFilterParams Class Doc Comment
 *
 * @category Class
 ...
 */
class CountCompaniesForAdvancedFilterParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CountCompaniesForAdvancedFilterParams';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('display_properties', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string[]|null $display_properties Select the display columns to return (e.g. plan, subscription, users, last_seen_at)
     *
     * @return self
     */
    public function setDisplayProperties($display_properties)
    {
        if (is_null($display_properties)) {
            throw new \InvalidArgumentException('non-nullable display_properties cannot be null');
        }
     ...
     * Sets feature_ids
     *
     * @param string[]|null $feature_ids Filter companies by one or more feature IDs (each ID starts with feat_)
     *
     * @return self
     */
    ...
    public function setSortOrderColumn($sort_order_column)
    {
        ...
        if ((mb_strlen($sort_order_column) > 255)) {
            throw new \InvalidArgumentException('invalid length for $sort_order_column when calling CountCompaniesForAdvancedFilterParams., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param \Schematic\Model\SubscriptionStatus[]|null $subscription_statuses Filter companies by one or more subscription statuses (active, canceled, expired, incomplete, incomplete_expired, past_due, paused, trialing, unpaid)
     *
     * @return self
     */
     ...
     *
     * @param \Schematic\Model\SubscriptionType[]|null $subscription_types Filter companies by one or more subscription types (paid, free, trial)
     *
     * @return self
     */
