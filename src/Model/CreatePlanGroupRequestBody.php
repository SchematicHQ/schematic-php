...
/**
 * CreatePlanGroupRequestBody Class Doc Comment
 *
 * @category Class
 * @package  Schematic
 * @author   OpenAPI Generator team
 ...
 */
class CreatePlanGroupRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreatePlanGroupRequestBody';
    ...
    */
    ...
    public function setPreventSelfServiceDowngradeButtonText($prevent_self_service_downgrade_button_text)
    {
        ...
        if (!is_null($prevent_self_service_downgrade_button_text) && (mb_strlen($prevent_self_service_downgrade_button_text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $prevent_self_service_downgrade_button_text when calling CreatePlanGroupRequestBody., must be smaller than or equal to 255.');
        }
    ...
    public function setPreventSelfServiceDowngradeUrl($prevent_self_service_downgrade_url)
    {
        ...
        if (!is_null($prevent_self_service_downgrade_url) && (mb_strlen($prevent_self_service_downgrade_url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $prevent_self_service_downgrade_url when calling CreatePlanGroupRequestBody., must be smaller than or equal to 512.');
        }
